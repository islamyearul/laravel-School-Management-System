    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ url('/admin/users') }}"><i class="ti-more"></i>View User</a></li>
                    <li><a href="{{ url('/admin/user-edit/'.Auth::user()->id) }}"><i class="ti-more"></i>Edit User</a></li>
                    <li><a href=""><i class="ti-more"></i>Update User</a></li>
